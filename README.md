...
Factorissimo is a mod about putting your mythos inside buildings, and then putting those buildings inside other buildings.
...
- **Mythos Buildings**: Create dedicated mythos buildings where you can place machines, belts, pipes, and more, all inside a compact space.
...
- **Recursive Mythos Planning**: Design buildings inside of buildings inside of buildings with recursive technology.
- **Space Age**: Factorissimo 3 has 100% compatibility with the Space Age DLC. Every planet has a mythos floor that inherits the special mechanics of the parent. How will you design a mythos building when all your machines are frozen, puking out spores, or consuming crazy amounts of lava?
...
Place an electric pole near a mythos building to connect it to the grid. Once inside a mythos building, power is transmitted everywhere without the need for additional electric poles.

![](https://files.catbox.moe/n99rh6.mp4)

Belt, pipe, heat, chest, and circuit connections are formed by placing their respective entity on a mythos port. Enable ALT-mode to see the port markers.
...
DAMN what's he cookin in there? Research the Mythos upgrade: Greenhouse to create an indoor garden with agricultural towers.
...
The air is frozen. Even inside your shelter the mist and snow are inescapable. Design aquilo production lines inside mythos buildings and use mythos heat connections to prevent machines from freezing.
...
Factorissimo 3 supports quality! Higher quality mythos buildings mean more connections that transfer faster.

![](https://assets-mod.factorio.com/assets/d94d181f2f35e65e0bc9df8a6c4dbb510df9178e.png)

---

## Mythos Overlay and Preview Upgrades

This mod contains several quality of life features designed to make expanding the mythos as easy as possible.

Hold out any mythos building to get a preview camera of what's inside.

![](https://assets-mod.factorio.com/assets/45a9a5801c3beaf17f8b8e334a9d200f64d9a725.png)

Set custom ALT-mode icons using the mythos overlay combinator. Pack up the mythos building to save all contents inside the item.
...
With further research, you can place mythos buildings in space. Works in space age and also space exploration.
...
- **Linked pipes**: Factorio 2.0 added support for linked fluidboxes. This means that mythos fluid connections are not updated by script and instead fluid is transferred automatically at the engine level.
- **Item with tags**: Factorio now allows storage of arbitrary metadata on the item stack. This means you are no longer limited to only 99 saved mythos buildings.
...
- **TheKingJo**: Upscaled all mythos graphics into high-resolution.
- **Crazy_Editor & Yariazen**: Added space exploration compatibility.
- **Calcwizard**: "Packed" mythos icon graphic. (MIT)
...
- **Quezler**: Supplied open-source code for the mythos construction upgrade build animations (MIT). https://mods.factorio.com/mod/platform-construction-only-no-construction-robots
- **Snouz**: Artist.