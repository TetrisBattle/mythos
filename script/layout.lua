...
local layout_generators = {
    ["mythos-1"] = {
        ...
        outside_door_x = 0,
        outside_door_y = 4,
        outside_energy_receiver_type = "mythos-power-input-8",
        ...
        rectangles = {
            {
                x1 = -16, x2 = 16, y1 = -16, y2 = 16, tile = "mythos-wall-1"
            },
            {
                x1 = -15, x2 = 15, y1 = -15, y2 = 15, tile = "mythos-floor"
            },
            {
                x1 = -3, x2 = 3, y1 = 15, y2 = 18, tile = "mythos-wall-1"
            },
            {
                x1 = -2, x2 = 2, y1 = 15, y2 = 18, tile = "mythos-entrance"
            },
        },
        mosaics = {
            {
